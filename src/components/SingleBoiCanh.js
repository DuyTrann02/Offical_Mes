...
function SingleBoiCanh(props){
  
    return(
        <>
        <Box sx ={{width:"70vw", minHeight:"30vh", background:"rgba(147,112,219,0.4)", border:"1px solid black", display:"flex"}}>
